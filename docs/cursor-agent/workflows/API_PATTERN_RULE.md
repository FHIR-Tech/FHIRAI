...
### **Quick Reference for User Context**

**For detailed user handling patterns, see**: `USER_HANDLING_GUIDE.md`
...
#### **User Information Access (Quick Reference):**
```csharp
...
- [ ] Authorization checks are performed (see `SECURITY_GUIDE.md`)
- [ ] Audit fields are properly set

**For detailed patterns and best practices, see**: `USER_HANDLING_GUIDE.md`